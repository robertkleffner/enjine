...
b.canvas.width,b.backBuffer.height=b.canvas.height,b.betterBuffer.width=b.backBuffer.width,b.betterBuffer.height=b.backBuffer.height}},changeCanvasResolution:function(a,b){this.autoResolutionMode=!1;this.backBuffer.width=a;this.backBuffer.height=b},changeCanvasSize:function(a,b){this.canvas.width=a;this.canvas.height=b;window.onresize=null;if(this.autoResolutionMode)this.backBuffer.width=this.canvas.width,this.backBuffer.height=this.canvas.height}};$e.Buttons={MouseLeft:0,MouseRight:2,MouseWheel:1};
$e.Mouse={x:0,y:0,pressed:[],element:null,initialize:function(a){var b=this;this.element=a;a.onmousedown=function(a){b.mouseDownEvent(a)};a.onmouseup=function(a){b.mouseUpEvent(a)};a.onmousemove=function(a){b.mouseMoveEvent(a)}},isButtonDown:function(a){if(this.pressed[a]!==null)return this.pressed[a];return!1},mouseDownEvent:function(a){this.pressed[a.button]=!0},mouseUpEvent:function(a){this.pressed[a.button]=!1},mouseMoveEvent:function(a){this.x=a.pageX;this.y=a.pageY;a=this.element;if(a.offsetParent){do this.x-=
a.offsetLeft,this.y-=a.offsetTop;while(a=a.offsetParent)}}};$e.DrawableManager=function(){this.unsorted=!0;this.objects=[]};
